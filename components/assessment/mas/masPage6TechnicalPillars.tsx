            ...
            <div className="ml-4 space-y-3 mt-3 pl-4 border-l-2 border-emerald-500">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[80px] rounded-xl ${errors.transparency_doc_types && touched.transparency_doc_types
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.transparency_doc_types &&
                  typeof errors.transparency_doc_types === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.transparency_doc_types}
                    </p>
                  )}
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[100px] rounded-xl ${errors.transparency_user_explanations && touched.transparency_user_explanations
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.transparency_user_explanations &&
                  typeof errors.transparency_user_explanations === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.transparency_user_explanations}
                    </p>
                  )}
              </div>
                <div className="space-y-2">
            ...
            <div className="ml-4 space-y-3 mt-3 pl-4 border-l-2 border-emerald-500">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[100px] rounded-xl ${errors.transparency_model_cards_details && touched.transparency_model_cards_details
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.transparency_model_cards_details &&
                  typeof errors.transparency_model_cards_details === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.transparency_model_cards_details}
                    </p>
                  )}
              </div>
            </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.transparency_explainability_methods && touched.transparency_explainability_methods
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.transparency_explainability_methods &&
              typeof errors.transparency_explainability_methods === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.transparency_explainability_methods}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.transparency_user_communication && touched.transparency_user_communication
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.transparency_user_communication &&
              typeof errors.transparency_user_communication === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.transparency_user_communication}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.transparency_decision_documentation && touched.transparency_decision_documentation
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.transparency_decision_documentation &&
              typeof errors.transparency_decision_documentation === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.transparency_decision_documentation}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.transparency_interpretability_requirements && touched.transparency_interpretability_requirements
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.transparency_interpretability_requirements &&
              typeof errors.transparency_interpretability_requirements === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.transparency_interpretability_requirements}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.transparency_stakeholder_communication && touched.transparency_stakeholder_communication
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.transparency_stakeholder_communication &&
              typeof errors.transparency_stakeholder_communication === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.transparency_stakeholder_communication}
                </p>
              )}
          </div>
        </div>
            ...
            <div className="ml-4 space-y-3 mt-3 pl-4 border-l-2 border-emerald-500">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[100px] rounded-xl ${errors.fairness_testing_methods && touched.fairness_testing_methods
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.fairness_testing_methods &&
                  typeof errors.fairness_testing_methods === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.fairness_testing_methods}
                    </p>
                  )}
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[100px] rounded-xl ${errors.fairness_test_results && touched.fairness_test_results
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.fairness_test_results &&
                  typeof errors.fairness_test_results === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.fairness_test_results}
                    </p>
                  )}
              </div>
              <div className="space-y-2">
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.fairness_protected_attributes && touched.fairness_protected_attributes
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.fairness_protected_attributes &&
              typeof errors.fairness_protected_attributes === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.fairness_protected_attributes}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.fairness_metrics_used && touched.fairness_metrics_used
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.fairness_bias_mitigation && touched.fairness_bias_mitigation
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.fairness_bias_mitigation &&
              typeof errors.fairness_bias_mitigation === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.fairness_bias_mitigation}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.fairness_continuous_monitoring && touched.fairness_continuous_monitoring
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.fairness_continuous_monitoring &&
              typeof errors.fairness_continuous_monitoring === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.fairness_continuous_monitoring}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.fairness_adverse_impact && touched.fairness_adverse_impact
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.fairness_adverse_impact &&
              typeof errors.fairness_adverse_impact === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.fairness_adverse_impact}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`rounded-xl ${errors.fairness_testing_frequency && touched.fairness_testing_frequency
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.fairness_testing_frequency &&
              typeof errors.fairness_testing_frequency === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.fairness_testing_frequency}
                </p>
              )}
          </div>
        </div>
            ...
            <div className="ml-4 space-y-3 mt-3 pl-4 border-l-2 border-emerald-500">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className={`min-h-[100px] rounded-xl ${errors.fairness_external_validation_details && touched.fairness_external_validation_details
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.fairness_external_validation_details &&
                  typeof errors.fairness_external_validation_details === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.fairness_external_validation_details}
                    </p>
                  )}
              </div>
            </div>
            ...
            <div className="ml-4 space-y-3 mt-3 pl-4 border-l-2 border-emerald-500">
              <div className="space-y-2">
                ...
                placeholder="e.g., Human-in-the-loop (HITL) - humans review every decision before execution. Human-on-the-loop (HOTL) - humans monitor and can intervene. Both - different processes for different scenarios."
                  className={`min-h-[100px] rounded-xl ${errors.human_oversight_type && touched.human_oversight_type
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.human_oversight_type &&
                  typeof errors.human_oversight_type === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.human_oversight_type}
                    </p>
                  )}
              </div>
              <div className="space-y-2">
...
placeholder="Describe: When do humans review decisions? What triggers human intervention? Who are the human reviewers? What is their authority level? Escalation procedures, etc."
                  className={`min-h-[100px] rounded-xl ${errors.human_oversight_processes && touched.human_oversight_processes
                    ? "border-red-500 focus:ring-red-500"
                    : ""
                    }`}
                />
                {touched.human_oversight_processes &&
                  typeof errors.human_oversight_processes === "string" && (
                    <p className="text-xs text-red-500 mt-1">
                      {errors.human_oversight_processes}
                    </p>
                  )}
              </div>
              <div className="space-y-2">
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_roles && touched.human_oversight_roles
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_roles &&
              typeof errors.human_oversight_roles === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_roles}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_qualifications && touched.human_oversight_qualifications
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_qualifications &&
              typeof errors.human_oversight_qualifications === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_qualifications}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_intervention_triggers && touched.human_oversight_intervention_triggers
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_intervention_triggers &&
              typeof errors.human_oversight_intervention_triggers === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_intervention_triggers}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_decision_authority && touched.human_oversight_decision_authority
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_decision_authority &&
              typeof errors.human_oversight_decision_authority === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_decision_authority}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_training && touched.human_oversight_training
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_training &&
              typeof errors.human_oversight_training === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_training}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_escalation && touched.human_oversight_escalation
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_escalation &&
              typeof errors.human_oversight_escalation === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_escalation}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={`min-h-[100px] rounded-xl ${errors.human_oversight_documentation && touched.human_oversight_documentation
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_documentation &&
              typeof errors.human_oversight_documentation === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_documentation}
                </p>
              )}
          </div>
        </div>
        ...
        <div className="space-y-3 border border-border rounded-xl p-4 glass-panel">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`rounded-xl ${errors.human_oversight_automation_percentage && touched.human_oversight_automation_percentage
                ? "border-red-500 focus:ring-red-500"
                : ""
                }`}
            />
            {touched.human_oversight_automation_percentage &&
              typeof errors.human_oversight_automation_percentage === "string" && (
                <p className="text-xs text-red-500 mt-1">
                  {errors.human_oversight_automation_percentage}
                </p>
              )}
          </div>
        </div>
