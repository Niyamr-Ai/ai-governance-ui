...
export default function DiscoveryDashboard() {
  ...
  const handleLinkAsset = async (assetId: string) => {
    ...
    try {
      ...
      const res = await fetch(`/api/discovery/${assetId}/link`, {
        method: "POST",
  ...
  const handleMarkShadow = async (assetId: string) => {
    ...
    try {
      setActionLoading(assetId);
      const res = await fetch(`/api/discovery/${assetId}/mark-shadow`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleResolve = async (assetId: string) => {
    ...
    try {
      setActionLoading(assetId);
      const res = await fetch(`/api/discovery/${assetId}/resolve`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ notes: notes || undefined }),
      });
  ...
  const handleCreateSystem = async (assetId: string) => {
    ...
    try {
      setActionLoading(assetId);
      const res = await fetch(`/api/discovery/${assetId}/create-system`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
