      ...
      <CardContent className="space-y-6">
        ...
        {(values.foundation_model === "yes" || values.foundation_model === "unsure") && (
          <div className="space-y-4 border-t pt-4">
            ...
            <div className="space-y-2">
              <EvidenceUpload
                label="Upload foundation model documentation, model cards, or capability assessments"
                accept=".pdf,.png,.jpg,.jpeg,.txt"
                value={values.foundation_model_evidence}
                onFileSelect={(file) => {
              ...
              {evidenceContent.uk_foundation_model_evidence && (
                <p className="text-xs text-emerald-400 mt-1">
                  ✓ File processed (
                  {evidenceContent.uk_foundation_model_evidence.length} characters extracted via OCR
                  )
                </p>
              )}
            </div>
