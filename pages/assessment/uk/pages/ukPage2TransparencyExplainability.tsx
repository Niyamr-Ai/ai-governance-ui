              ...
              <div className="ml-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-12 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors ${
                    values.user_disclosure ? "bg-emerald-600 border-emerald-500" : "bg-gray-400 border-gray-500"
                  }`}
                ...
                >
                  <span className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform ${
                    values.user_disclosure ? "translate-x-5" : "translate-x-0"
                  }`} />
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="ml-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-12 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors ${
                    values.explainability ? "bg-emerald-600 border-emerald-500" : "bg-gray-400 border-gray-500"
                  }`}
                  style={{ backgroundColor: values.explainability ? '#10b981' : '#9ca3af' }}
                >
                  <span className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform ${
                    values.explainability ? "translate-x-5" : "translate-x-0"
                  }`} />
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="ml-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-12 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors ${
                    values.documentation ? "bg-emerald-600 border-emerald-500" : "bg-gray-400 border-gray-500"
                  }`}
                  style={{ backgroundColor: values.documentation ? '#10b981' : '#9ca3af' }}
                >
                  <span className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform ${
                    values.documentation ? "translate-x-5" : "translate-x-0"
                  }`} />
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="ml-4 flex items-center gap-2">
                ...
                <button
                  ...
                  className={`relative inline-flex h-7 w-12 shrink-0 cursor-pointer items-center rounded-full border-2 transition-colors ${
                    values.transparency_reports ? "bg-emerald-600 border-emerald-500" : "bg-gray-400 border-gray-500"
                  }`}
                  style={{ backgroundColor: values.transparency_reports ? '#10b981' : '#9ca3af' }}
                >
                  <span className={`pointer-events-none inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform ${
                    values.transparency_reports ? "translate-x-5" : "translate-x-0"
                  }`} />
                </button>
              </div>
            </div>
